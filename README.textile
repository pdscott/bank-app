...
Question 27 and 28: When a user's account is deleted, records of it will be erased from the history of our application. This includes any records of transactions. Although these records will be erased upon deletion, the balances incurred by the transations of the account will remain. That is, transactions will not be reversed once they have been approved by admins in cases where approval is necessary.
...
Question 34: In the event that an administrator deletes a user that has accounts with pending transactions, the records of the user and their transactions will be erased from the history of the application. Pending transactions will not post in this case and will not change tha balance of any accounts. 
