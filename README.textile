...
We did not provide any seeded users for testing purposes in this submission because there was no way to secure them from malicious intent. User details were being changed which gave the appearance of our application being broken when nothing was genuinely wrong with the functionality. As you use our application, we ask that you please use create your own accounts and use those. The Super Administrator account credentials have been provided, this account has been secured against modification. 
